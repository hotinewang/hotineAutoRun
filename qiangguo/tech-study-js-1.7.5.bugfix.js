...
/**
 * @description 初始化logo（只是在控制台输出一个tech-study.js+版本号）
 */
function initLogo() {
...
function initSettings() {
    try {
        ...
        log("initSettings()出错" + e)
    }
}
/**
 * @description 初始化配置（无关紧要）
 */
